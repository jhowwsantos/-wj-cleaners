...
export const AddStaffModal: React.FC<AddStaffModalProps> = ({ isOpen, onClose }) => {
  const { registerNewStaff, currentCompany, users } = useApp();
  ...
  const handleNameChange = (newName: string) => {
    const autoEmail = generateStaffEmail(newName, users);
    setFormData((prev) => ({
      ...prev,
      name: newName,
      email: autoEmail,
        ...
        <div className="p-5 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-slate-50/80 dark:bg-slate-800/80">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                Criar conta de acesso com e-mail e senha automáticos.
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              <label className="text-xs font-bold text-slate-700 dark:text-slate-300 flex items-center justify-between">
                <span>E-mail (Gerado Automático) *</span>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  readOnly
                  required
                  placeholder="nome.sobrenome@wjcleaners.co.uk"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div>
              ...
              >
                <option value="CLEANER">Funcionário (Faxineiro/Cleaner)</option>
