        ...
        <div className="p-6 space-y-5">
          ...
          <div className="text-center pb-4 border-b border-slate-100 dark:border-slate-700">
            <div className="flex justify-center mb-2">
              <CompanyLogo company={currentCompany} className="w-16 h-16 rounded-xl" />
            </div>
            <h2
              className="text-2xl font-black text-blue-900 dark:text-blue-400 tracking-tight transition-colors"
              style={{ color: currentCompany.primaryColor || undefined }}
            >
              {currentCompany.name}
            </h2>
          ...
          <div className="space-y-3 text-sm text-slate-700 dark:text-slate-300 bg-slate-50 dark:bg-slate-900/50 p-4 rounded-xl border border-slate-100 dark:border-slate-800">
            ...
            <div className="flex justify-between pt-1">
              ...
              <span className="font-medium text-slate-900 dark:text-slate-100">
                {job.cleanerName || `${currentCompany.name} Team`}
              </span>
            </div>
          </div>
          ...
          {userRole !== 'CLEANER' ? (
            ...
            <div className="flex justify-between items-center p-4 bg-emerald-50 dark:bg-emerald-950/50 rounded-xl border border-emerald-200 dark:border-emerald-900">
              <span className="text-sm font-bold text-emerald-900 dark:text-emerald-200">{language === 'pt' ? 'Serviço Executado' : 'Service Completed'}</span>
