...
function AppContent() {
  const { activeTab, isAuthenticated, userRole, isSuperAdmin, currentCompany } = useApp();
    ...
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-slate-100 transition-colors font-sans antialiased flex flex-col">
      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 min-w-0">
          ...
          {activeTab === 'clients' && userRole === 'OWNER' && (
            <ClientsView
          ...
          {activeTab === 'saas' && (isSuperAdmin || !isWJCompany(currentCompany)) && <ReportsView />}
        </main>
      </div>
